...
var fileTypeFromBuffer = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(buf) {
...
function _getMIMEFromBuffer() {
  _getMIMEFromBuffer = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(buffer, path) {
    var fileType;
...
function parseBitmap(data, path, cb) {
  ...
  getMIMEFromBuffer(data, path).then(function (mime) {
    ...
    try {
      ...
      if (_this.constructor.decoders[_mime]) {
        ...
        return _utils.throwError.call(_this, 'Unsupported MIME type: ' + _mime, cb);
      }
    } catch (error) {
    ...
    cb(new Error('Could not find MIME for Buffer <' + path + '> ' + error.message));
  });
}
